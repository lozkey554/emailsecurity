...
<div class="w3-sidebar w3-bar-block w3-border-right" id="mySidebar" style="display:none">
  ...
  <a href="draft.php" class="w3-bar-item w3-button active"><img src="../images/icons/New Post_48px.png" alt="" height="20" width="20">&nbsp;&nbsp; Draft</a>
...
<!-- desktop -->
<div class="w3">
    <p class="text-center" style="font-size: 30px;color: white;font-weight: bold;">Draft</p>
...
<div class="jumbotron">
    <div class="alert alert-danger" id="nomessage" style="display: none;"><img src="../images/icons/Cancel 2_48px.png" alt=""><span style="font-size: 20px;text-align: center;"> Draft is Empty</div>
        <div>
          <ul id="messages">
...
$.ajax({
     ...
     success: function(tx){
         ...
         tx.draftmail.forEach((value,key) => {
             let eachmessage = `<li class='list alert alert-primary'> <span class='send'> ${tx.date[key]}</span> 
             <a href='viewdraft.php?id=${ tx.id[key] }'> ${value} </a></li>`;
...
$("#darkmode").on("click", function(e){
  ...
  e.preventDefault();
  $.ajax({
    url: "../app.controller/darkmode.php",
    type: "post",
    dataType: "json",
    data:{
      "function": "darkmode"
