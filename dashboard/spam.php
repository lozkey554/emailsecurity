...
<div class="w3-sidebar w3-bar-block w3-border-right" id="mySidebar" style="display:none">
  ...
  <a href="spam.php" class="w3-bar-item w3-button active"><img src="../images/icons/High Priority_48px.png" alt="" height="20" width="20">&nbsp;&nbsp; Spam Mails  <?php if($count2 !=0){ ?> <span style="padding:5px; border-radius: 50%;background-color: darkred;color: white;"><?php echo $count2; }?></span></a>
...
<!-- desktop -->
<div class="w3">
    <p class="text-center" style="font-size: 30px;color: white;font-weight: bold;">Spam Mails</p>
...
<div class="jumbotron"> 
<div class="alert alert-danger" id="nomessage" style="display: none;"><img src="../images/icons/Cancel 2_48px.png" alt=""><span style="font-size: 20px;text-align: center;"> Spam is Empty</div>
    <div>
        <ul id="messages">
 ...
 $.ajax({
     ...
     success: function(tx){
         ...
         tx.subject.forEach((value,key) => {
             ...
             <a href='viewspam.php?id=${ tx.id[key] }'> ${value} </a></li>`;
